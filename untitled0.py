...
Original file is located at
    https://colab.research.google.com/drive/1fBCat6_6DGUEY7dxlyEfcrOKN2QYkRM0
"""

# Automatic Ticket Classification using a Transformer Model (DistilBERT) for High Accuracy
# This script fine-tunes a pre-trained model from Hugging Face.

# -----------------------------------------------------------------------------
# STEP 0: INSTALL REQUIRED LIBRARIES
# -----------------------------------------------------------------------------
# In a Colab or Jupyter notebook, you would run these commands in a cell first:
...
try:
    ...
    data = {'subject': ['Incorrect Bill', 'Login Help', 'Outage'],
            'body': ['My bill is incorrect.', 'Cannot log in.', 'Service is down.'],
            'queue': ['Billing and Payments', 'IT Support', 'Service Outages and Maintenance']}
...
# ADDED: Basic text cleaning function
def clean_text(text):
...
# --- CRITICAL CHANGE: COMBINE SUBJECT AND BODY ---
...
MAX_LEN = 170 # Increase max length slightly for combined text
...
# -----------------------------------------------------------------------------
# STEP 7.5: CREATE OPTIMIZER WITH LEARNING RATE SCHEDULER
# -----------------------------------------------------------------------------
print("\nCreating optimizer with a learning rate scheduler...")
EPOCHS = 8 # Increased epochs for better convergence
BATCH_SIZE = 16 # Smaller batch size is common for large models
...
# -----------------------------------------------------------------------------
# STEP 8.5: SAVE THE FINE-TUNED MODEL AND TOKENIZER
# -----------------------------------------------------------------------------
# After training, it's best practice to save your model for future use.
...
# To reuse the model later, you can load it like this:
...
# -----------------------------------------------------------------------------
# STEP 10: GEMINI API INTEGRATION (DEMONSTRATION)
# -----------------------------------------------------------------------------
# This section is identical to the previous script but now uses the superior model.
